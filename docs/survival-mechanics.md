...
- **Combined cap:** deprivation conditions from this module never stack to more than **Fatigued + one other** at once. One bad week reads as "you're suffering," not as three simultaneous diseases. (This is the single biggest revision from the first draft, which could pile five penalties on one PC.)
